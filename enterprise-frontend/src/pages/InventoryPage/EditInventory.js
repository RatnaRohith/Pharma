...
`;
const EditInventory = ({ id, selectedInventory, stores, updated }) => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      const { data } = await updateInventory(id, payload)
      setIsModalVisible(false);
      message.success('Inventory is successfully updated.');
      updated();
    } catch (ex) {
      ...
      >
        ...
        >
          <Form.Item
            label="Medicine name"
            name="name"
            initialValue={selectedInventory.name}
          ...
          <Form.Item
            label="Quantity"
            name="quantity"
            initialValue={selectedInventory.quantity}
          ...
          <Form.Item
            label="Select Store"
            name="store"
            initialValue={selectedInventory.store}
          ...
          <Form.Item
            ...
            initialValue={selectedInventory.requiresIdVerification.toString()}
